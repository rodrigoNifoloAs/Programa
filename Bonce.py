...
while(True):
    ...
    print('[4]-Elegir-Perrito-')
    print('[5]-Elegir-Conejito-')
    print('[6]-Elegir-Robot-')
    print('[7]-Elegir-SuperPc-')
    print('[8]-Elegir-GatoTanke-')
    print('[9]-Elegir-UNAflor-')
    print('[10]-Elegir-Calabitaciga-')
...
print('Gracias por realizar el cambio')
